...
class SampleTest(TestCase):
    ...
    def test_2_create_blog_post(self):
        ...
        self.assertLessEqual(BlogPost.objects.get(
            id=1).date_created - dt, timedelta(seconds=3))
    ...
    def test_6_blog_comments_copy(self):
        a1 = Author.objects.create(name='mohammad')
        p1 = BlogPost.objects.create(author=a1, title='t1', body='b1')
        Comment.objects.create(blog_post=p1, text='commenttt')
        Comment.objects.create(blog_post=p1, text='commenttt')
        Comment.objects.create(blog_post=p1, text='commenttt')
